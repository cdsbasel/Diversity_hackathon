...
- The figure above shows evidence of a publication gender gap, with fewer publications of the University of Basel involving females relative to males (`r round(prop_fem_total$prop_female, 0)`%). Notwithstanding, the figure suggests there has been an general upward trend in the percentage of publications involving female authors over the last two decades. While in 2000 about `r round(prop_fem$prop_female[1], 0)`% of authors were female, this share has increased to `r round(prop_fem$prop_female[2], 0)`% in 2020.

- The overall levels as well as temporal trend vary, however, across faculties. Some faculties have a greater percentage of female authors overall, most notably the Faculty of Humanities and Social Sciences (`r round(prop_fem_inst_nyr$prop_female[prop_fem_inst_nyr$organisation_name == "Humanities &\nSocial Sciences"], 0)`%), the Faculty of Psychology (`r round(prop_fem_inst_nyr$prop_female[prop_fem_inst_nyr$organisation_name == "Psychology"], 0)`%), and the Faculty of Law (`r round(prop_fem_inst_nyr$prop_female[prop_fem_inst_nyr$organisation_name == "Law"], 0)`%). Concerning trends, while for the Faculty of Psychology the increase of percentage points between 2000 to 2020 was `r round(prop_fem_inst$diff[prop_fem_inst$organisation_name == "Psychology" & prop_fem_inst$year == 2000], 0)`%, the Faculty of Law saw an increase between 2000 to 2020 of `r round(prop_fem_inst$diff[prop_fem_inst$organisation_name == "Law" & prop_fem_inst$year == 2000], 0)`%. 


```{r, echo=FALSE, eval=TRUE, fig.width = 20, fig.height= 21}
...
Publication data for the Faculty of Theology allows for less confident statements but suggests a decrease in the proportion of female authors.
