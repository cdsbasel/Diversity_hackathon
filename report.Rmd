...
Past work has show a publication gender gap in the sciences (e.g., Ni, Smith, Yuan, Larivière, & Sugimoto, 2021; Odic & Wojcik, 2020). In what follows, we assess the publication gender gap at the University of Basel based on all outputs available in the university's research database. The figure below shows the publication gap over time separately for each of the 7 faculties of the University of Basel. 
...
- We identified a persistent and sizable publication gender gap at the University of Basel in the 2000 to 2020 period. 
