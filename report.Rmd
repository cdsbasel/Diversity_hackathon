...
- We use faculty as organizational unit but some faculties are composed of an htereogenous number of departments covering different academic fields that may differ from each other in several respects (e.g., Faculty of Sciences). Future work could conduct more specific analysis per department or academic field, albeit smaller number of publications per organizational unit may present a limiting factor for such analyses. 
...
To the extent that factors leading to the employment gap are the same or correlated with the factors leading to publication success, one can expect the publication gap to be of the same or greater magnitude than the employment gap.

Past work suggests that females are more likely to dedicate more time to teaching, have more family responsibilities, and receive less funding and recognition, each of these contributing to a widening of the gender publication gap over time relative to the extant employment gap. Monitoring the publication gap and, ideally, its underlying causes - particularly the available institutional resources - could be an important contribution of higher-education institutions to advancing equal opportunities in science and innovation. The flow diagram above lists some factors derived from the existing literature on the employment and publication gaps (e.g.Huang et al., 2020; Ni et al. 2021, Odic & Woicik, 2020) that may contribute to a widening gap between employment and publication. 

<img src="3_figures/leakypipeline.png" width="80%"></img>

There are a few recommendations that result from the results above. 

- The University of Basel could expand its monitoring to include inequalities in research productivity and factors associated with such inequalities, most centrally monitoring of internal funding (startup, support staff). 

- The University of Basel could be interested in linking academic productivity with individual characteristics that may or may not be currently available for analysis (e.g., family status, childcare). There are several challenges associated with this approach, including issues of privacy and equity but analyses of the nature we present above using such variable promise to provide more informed decisions concerning the role of personal characteristics that may or may not be amenable to intervention by higher-education institutions, such as the University of Basel. 
