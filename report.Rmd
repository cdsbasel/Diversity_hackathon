...
names(table)<-c("Faculty","N","% Female","% Fem 2000", "% Fem 2020", "Diff")
...
- As can be seen in the upper panel, there is a general trend for larger proportion of females in first vs. last authors; this pattern matches the larger prevalence of females in junior (academic staff) vs. senior (professorship) roles that is evident in the lower panel. 

- As presented in the previous section concerning the overall percentage of females, the temporal trends split by first vs. last author show similar increases over time, and, again, with patterns differing somewhat betwen faculties. Crucially, the temporal trends observed are not always parallel for first and last authors (cf. Natural Sciences, Psychology, Theology) suggesting that the dynamics underlying academic productivity can differ somewhat for the different career stages, at least for some faculties. 

### Key findings

- We identified a persistent and sizable publication gender gap at the University of Basel between 2000 and 2020. 
...
- The publication gender gap is larger and more persistent for last (i.e., senior authors) for some faculties, suggesting that different dynamics are at play for different career stages for at least some organizational units of the University of Basel. 
