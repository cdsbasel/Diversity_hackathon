...
We use data from a database listing the University of Basel's research output. We focus on data between 2000 and 2020 because availability for earlier years is very limited and this time range allows some comparability to previous efforts (Odic & Wojcik, 2019). We focus pur analyses on faculties and neglect smaller associated institutes because there is large number of the latter with relatively few publications that make it difficult to consider trends over time.
