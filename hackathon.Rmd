...
Dr. Dirk Wulff and Prof. Dr. Rui Mata supervised the project and Dr. Dirk Wulff conducted all data preprocessing. The complete list of contributors can be found in the [Contributors](contributors.html) page. The project consists of a series of planning [sessions](https://psychologie.unibas.ch/de/fakultaet/abteilungen/cognitive-and-decision-sciences-305/events/) and two collaborative [hackathons](hackathon.html) described below. Resources related to the hackathons are available on this <a href="https://github.com/cdsbasel/Diversity_hackathon"><b>Github repository</b></a>. 
